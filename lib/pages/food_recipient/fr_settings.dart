...
class FrSettings extends StatefulWidget {
  const FrSettings({Key? key}) : super(key: key);

  @override
  _FrSettingsState createState() => _FrSettingsState();
}

class _FrSettingsState extends State<FrSettings> {
